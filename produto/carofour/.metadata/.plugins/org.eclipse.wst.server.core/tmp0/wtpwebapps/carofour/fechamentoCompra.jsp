    ...
    <jsp:body>		
        <form action="finalizar" method="POST" id="formCadastro">
            <div class="conteudo--interno conteudo--50 destaque">
                ...
                <div class="formulario--dados">
                    <input type="text" name="nascimento" id="nascimento" class="texto--formulario" placeholder="<fmt:message key="campo.dataNascimento"/>" data-mask="date" required>
                </div>
            ...
            <div class="conteudo--interno conteudo--50 destaque">
                ...
                <div class="formulario--dados input-radio align-left">
                    <input type="radio" name="tipoPagamento" value="boleto" checked><fmt:message key="campo.boleto"/>
                    <br>
                    <input type="radio" name="tipoPagamento" value="credito"><fmt:message key="campo.credito"/>
                </div>
